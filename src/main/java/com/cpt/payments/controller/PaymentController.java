...
public class PaymentController {
	...
	public String createPayment(@RequestBody PaymentRequest paymentRequest) {
		...
		PaymentRequestDTO paymentRequestDTO = modelMapper.map(paymentRequest, PaymentRequestDTO.class); //TODO conversion req to dto
		
		String response = paymentService.validateAndProcessPayment(paymentRequestDTO);
		
		return "Payment completed | " + response;
	}
